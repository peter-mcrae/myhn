...
function MongoDB (db,collection) {
	...
	this.uri = nconf.get('mongo_uri') + '/' + this.db || 'mongodb://' + nconf.get('mongo_user') + ':' + nconf.get('mongo_pass')+ '@'+ this.host + ':' + this.port + '/' + this.db; // use for localhost 'mongodb://localhost:27017/models'
